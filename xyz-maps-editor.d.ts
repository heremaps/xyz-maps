 ...
 */
export declare class ConnectionCandidate {
    /**
 ...
 */
export declare type EditorEventTypes = 'tap' | 'dbltap' | 'pointerup' | 'pointerdown' | 'pointerenter' | 'pointerleave' | 'featureUnselected' | 'error' | 'geometryValidation' | 'dragStart' | 'dragStop';
