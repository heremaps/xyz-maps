...
export interface LineStyle {
    ...
    /**
     * Altitude of the Line in meters.
     *
     * Describes the vertical distance from the global ground plane (0m) to the Line.
     *
     * Supported values:
     ...
     *         If the geometry altitude source differs from the TerrainTileLayer elevation source/resolution,
     *         the Line is not clamped to (and may intersect) the rendered terrain,
     *         so it can appear slightly above or below the visible surface.
     *
     ...
     *
     * Notes:
     * - Use 'terrain' to keep the Line visually seated on the rendered terrain.
