...
export const karmaConfig = {
    ...
    files: [
        ...
        {pattern: 'tests/dist/editor/editorTests*.js', watched: true, served: true, included: true, nocache: true},
        {pattern: 'tests/dist/editor/specs*.js', watched: true, served: true, included: true, nocache: true}
    ],
    ...
    htmlReporter: {
        outputDir: 'dist/editor/output', // where to put the reports
