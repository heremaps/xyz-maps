...
export const karmaConfig = Object.assign(karmaBaseConfig, {
    files: [
        ...
        {pattern: 'tests/dist/integration/integrationTests*.js', watched: true, served: true, included: true},
        {pattern: 'tests/dist/integration/specs*.js', watched: true, served: true, included: true}
    ],

    customContextFile: 'tests/dist/integration/runnerintegration.html',
    // customContextFile: 'tests/image-layer.html',

    customDebugFile: 'tests/dist/integration/runnerintegration.html',

    jsonReporter: {
        stdout: false,
        outputFile: 'tests/dist/integration/output/report.json' // defaults to none
    }
});
