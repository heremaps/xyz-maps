...
describe('collision detection - Group', function() {
    ...
    it('remove top circle', async () => {
        let style1 = testLayer.getStyleGroup(feature1);
        testLayer.setStyleGroup(feature1, [style1[1]]);
