...
describe('StyleGroup Image and Line geometry', () => {
    ...
    const magentaImg = 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAgAAAAICAYAAADED76LAAAAFElEQVR42mP8z/D/PwMewDgyFAAApMMX8QnY984AAAAASUVORK5CYII=';
    ...
    it('style icons and validate', async () => {
        layer.setStyleGroup(line1, [{
            'zIndex': 1, 'type': 'Image', 'src': blueImg, 'width': 28, 'opacity': 1
        }]);
    ...
    it('set anchor to Line', async () => {
        layer.setStyleGroup(line1, [{
            'zIndex': 1, 'type': 'Image', 'width': 28, 'src': blueImg, 'anchor': 'Line'
        }]);
    ...
    it('stlye line 2', async () => {
        layer.setStyleGroup(line2, [{
            'zIndex': 1, 'type': 'Image', 'width': 28, 'src': greenImg
        }]);
    ...
    it('set anchor2 to Line', async () => {
        layer.setStyleGroup(line2, [{
            'zIndex': 2, 'type': 'Image', 'width': 12, 'src': greenImg, 'anchor': 'Line'
        }]);
